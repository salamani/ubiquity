...
type FakeStorageClient struct {
	...
	CreateVolumeNameStub        func(createVolumeRequest resources.CreateVolumeRequest) (string, error)
	createVolumeNameMutex       sync.RWMutex
	createVolumeNameArgsForCall []struct {
		createVolumeRequest resources.CreateVolumeRequest
	}
	createVolumeNameReturns struct {
		result1 string
		result2 error
	}
	createVolumeNameReturnsOnCall map[int]struct {
		result1 string
		result2 error
	}
...
func (fake *FakeStorageClient) CreateVolumeName(createVolumeRequest resources.CreateVolumeRequest) (string, error) {
	fake.createVolumeNameMutex.Lock()
	ret, specificReturn := fake.createVolumeNameReturnsOnCall[len(fake.createVolumeNameArgsForCall)]
	fake.createVolumeNameArgsForCall = append(fake.createVolumeNameArgsForCall, struct {
		createVolumeRequest resources.CreateVolumeRequest
	}{createVolumeRequest})
	fake.recordInvocation("CreateVolumeName", []interface{}{createVolumeRequest})
	fake.createVolumeNameMutex.Unlock()
	if fake.CreateVolumeNameStub != nil {
		return fake.CreateVolumeNameStub(createVolumeRequest)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
	return fake.createVolumeNameReturns.result1, fake.createVolumeNameReturns.result2
}

func (fake *FakeStorageClient) CreateVolumeNameCallCount() int {
	fake.createVolumeNameMutex.RLock()
	defer fake.createVolumeNameMutex.RUnlock()
	return len(fake.createVolumeNameArgsForCall)
}

func (fake *FakeStorageClient) CreateVolumeNameArgsForCall(i int) resources.CreateVolumeRequest {
	fake.createVolumeNameMutex.RLock()
	defer fake.createVolumeNameMutex.RUnlock()
	return fake.createVolumeNameArgsForCall[i].createVolumeRequest
}

func (fake *FakeStorageClient) CreateVolumeNameReturns(result1 string, result2 error) {
	fake.CreateVolumeNameStub = nil
	fake.createVolumeNameReturns = struct {
		result1 string
		result2 error
	}{result1, result2}
}

func (fake *FakeStorageClient) CreateVolumeNameReturnsOnCall(i int, result1 string, result2 error) {
	fake.CreateVolumeNameStub = nil
	if fake.createVolumeNameReturnsOnCall == nil {
		fake.createVolumeNameReturnsOnCall = make(map[int]struct {
			result1 string
			result2 error
		})
	}
	fake.createVolumeNameReturnsOnCall[i] = struct {
		result1 string
		result2 error
	}{result1, result2}
}
